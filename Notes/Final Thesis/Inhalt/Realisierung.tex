...
Das MainModel ist, wie der Name schon sagt, das Haupt-Model, das alle
...
Das IsIntegrating Property gibt an, ob diese Softwarezelle eine Integration
...
\begin{figure}[H]
	\makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{./img/csvtabellierenDexel.png}}%
	\caption{CSV Tabellieren - Flow Design aus YouTube Video}
\end{figure}
...
\begin{figure}[H]
	\makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{./img/shoppingSimulator.png}}%
