...
verbinden. Dadurch lassen sie die Datenflüsse modellieren.
	...
	\subsubsection{MISSING IMAGES DataStreamDefinition}
...
\subsection{Vorstellung - was erreicht wurde}
\subsubsection{CSV Tabellieren -  Beispiel aus YouTube Video von Ralf Westphal}
...
\subsubsection{Shopping Simulator - Komplexes Beispiel}
\begin{figure}[H]
	\centering
...
\begin{lstlisting}[caption=Shopping Simulator - automatisch generierter Code]
public class Person
{
    public int Age;
    public string Name;
