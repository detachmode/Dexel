...
Bei einem Datenstrom, bestehend aus einem eigenen Datentypen, kann es helfen, den Datentyp innerhalb des Flow Design Diagrammes zu definieren.
...
Integrationen integrieren andere Integrationen und/oder Operationen in das Programm. Sie dürfen also anderen von Funktionseinheiten funktional abhängig sein.
...
Kommunikation zwischen Operationen. Mit Daten sind hauptsächlich die nicht-persistente
