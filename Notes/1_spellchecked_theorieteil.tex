...
\begin{center}
	\includegraphics[width=.9\linewidth]{./img/diagram1.png}
\end{center}
...
Falls der Datentyp offensichtlich - oder nicht so relevant ist - kann auch anstatt des Datentypen nur der Namen in die runden Klammern eingetragen
werden.

\section{Hierarchische Datenflüsse}
\begin{center}
	\includegraphics[width=.9\linewidth]{./img/diagramHir.png}
\end{center}
...
\section{{\bfseries\sffamily MISSING IMAGES} Definition eigener Datentypen}
...
\section{{\bfseries\sffamily MISSING IMAGES} Arrays (auch mit fester Größe)}
...
\section{{\bfseries\sffamily MISSING IMAGES} Mehrere Inputs / Outputs auf einem Weg}
...
sollen und dieser dann als Input in eine anderen Funktionseinheit hinein fließen
...
\section{{\bfseries\sffamily MISSING IMAGES} Abhängigkeiten / Provider}
...
\section{{\bfseries\sffamily MISSING IMAGES} GUIS / Programmstart/ Ende}
...
\section{{\bfseries\sffamily MISSING IMAGES} Klassen / Container definieren}
