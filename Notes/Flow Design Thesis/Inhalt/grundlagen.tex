...
In diesem Beispiel produziert G ein x und H ein y. Sowohl G als auch H nehmen keine Daten beim Aufruf entgegen.
In die Funktionseinheit F fließen die Daten aus G und H hinein.
