...
namespace Dexel.Model
{
    ...
    {
        public static IEnumerable<FunctionUnit> GetAll(Guid softwareCellID, MainModel mainModel)
        {
            return mainModel.FunctionUnits.Where(x => x.ID.Equals(softwareCellID));
        }
