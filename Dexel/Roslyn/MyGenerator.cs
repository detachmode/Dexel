...
namespace Roslyn
{
    ...
    public class MyGenerator
    {
        ...
        public void GenerateCodeWithNamespace(MainModel model, Action<string> generatedCode)
        {
            ...
            GenerateCode(usingDirectives, namespaceDeclaration, generatedCode);           
        }
        ...
        private void GenerateCode(SyntaxNode usingDirectives, SyntaxNode namespaceDeclaration, Action<string> onGeneratedCode)
        {
            AdhocWorkspace cw = new AdhocWorkspace();
            OptionSet options = cw.Options;
