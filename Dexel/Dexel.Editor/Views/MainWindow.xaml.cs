...
namespace Dexel.Editor.Views
{
    ...
    public partial class MainWindow
    {
        ...
        private void MenuItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            Interactions.AddNewIOCell(myUiElementPosition, MainViewModel.Instance().Model);
        }

        private void MenuItem_GenerateCode(object sender, RoutedEventArgs e)
        {
            Interactions.ConsolePrintGeneratedCode(MainViewModel.Instance().Model);
        }

        private void MenuItem_DebugPrint(object sender, RoutedEventArgs e)
        {
            Interactions.DebugPrint(MainViewModel.Instance().Model);
        }

        private void CheckBox_Checked(object sender, RoutedEventArgs e)
        {
            Interactions.AutoPrint(MainViewModel.Instance().Model, Interactions.DebugPrint);
        }
        ...
        {
            Interactions.AutoPrint(MainViewModel.Instance().Model, Interactions.ConsolePrintGeneratedCode);
        }
